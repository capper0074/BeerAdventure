        ...
        public static void Initialize()
        {
            ...
            Choice cobblerSectionBuyShoes = new(
                ...
                () =>
                {
                    ...
                    Item leatherBoots = new("Old leather boots", "Some old leatherly smelly pissy boots...", Size.Medium);

                    InventoryManager.MediumItems.Add(leatherBoots);
                    InventoryManager.Coins -= 69; // Nice!
                },
                () =>
                {
            ...
            Choice swampSectionTalkToWitch = new(
                "... hollar at the crooked backed witch bog.",
                () =>
                {
                    if (!GameStateManager.GetState(State.HasReceivedSecretBushStashHint))
                    {
                        Beautifier.DisplayString("Your shouts startle the crooked-backed witch in the murky swamp. \n" +
